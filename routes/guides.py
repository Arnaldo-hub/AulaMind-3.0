...
routes/guides.py
-----------------------------------------------------------
Módulo de Guías de Apoyo y Aprendizaje IA
===========================================================
"""
...
def index():
    ...
    return render_template(
        "guides.html",
        guide_count=stats.get("guide_count", 0),
...
# ==========================================================
# OBTENER DOCUMENTO (ABRIR)
# ==========================================================

@guides.route("/<document_id>")  # ← RUTA CORRECTA: /guides/<id>
...
@guides.route("/<document_id>", methods=["DELETE"])  # ← RUTA CORRECTA: /guides/<id>
...
@guides.route("/export-links/<document_id>")  # ← RUTA CORRECTA: /guides/export-links/<id>
