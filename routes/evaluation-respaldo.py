...
@evaluation.route("/list", methods=["GET"])
def list_evaluations():
    ...
    try:
        ...
        documents = persistence_service.list_documents(
...
@evaluation.route("/<int:document_id>", methods=["GET"])
def get_evaluation(document_id):
...
@evaluation.route("/<int:document_id>", methods=["DELETE"])
def delete_evaluation(document_id):
